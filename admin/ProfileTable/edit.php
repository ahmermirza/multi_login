...
<img src="<?php echo '../../image/'.$row['profile_pic']; ?>" width="120" height="120">
<a href="change-image.php?userid=<?php echo $row['id'];?>">Change Image</a>
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="contactno" value="<?php echo $row['phone'];?>" required="true" maxlength="10" pattern="[0-9]+">
        </div>
        <div class="form-group">
