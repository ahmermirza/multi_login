...
if (isset($_POST['submit'])) {
	...
	$query = mysqli_query($con, "update users set username='$username', first_name='$fname', last_name='$lname', phone='$contno', email='$email', address='$add', post_nr='$post_nr', country='$country', salary='$salary' where id='$eid'");
...
<body>
	<div class="signup-form" style="width: 520px;">
		<form method="POST">
			<?php
			$eid = $_GET['editid'];
			...
			?>
				...
				<div class="form-group">
					<div class="row">
						<div class="col"><input type="email" class="form-control" name="email" value="<?php echo $row['email']; ?>" required="true"></div>
						<div class="col"><input type="text" class="form-control" name="contactno" value="<?php echo $row['phone']; ?>" required="true" maxlength="10" pattern="[0-9]+"></div>
					</div>
				</div>
				<div class="form-group">
					<div class="row">
						...
						<div class="col-3">
							<input type="text" class="form-control" name="post_nr" value="<?php echo $row['post_nr']; ?>" required="true">
						</div>
						<div class="col-3">
				...
				<div class="form-group">
					<input type="number" class="form-control" name="salary" value="<?php echo $row['salary']; ?>" required="true">
				</div>
