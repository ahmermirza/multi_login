...
if(isset($_POST['submit']))
  {
    ...
    //Query for data updation
     $query=mysqli_query($db, "update  tblusers set FirstName='$fname',LastName='$lname', MobileNumber='$contno', Email='$email', Address='$add' where ID='$eid'");
...
<div class="signup-form">
 ...
 <?php
$eid=$_GET['editid'];
$ret=mysqli_query($db,"select * from tblusers where ID='$eid'");
